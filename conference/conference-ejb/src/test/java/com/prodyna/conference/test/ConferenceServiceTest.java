...
public class ConferenceServiceTest extends AbstractDeployableTest {
	...
	public void createComplex() throws Exception {
		...
		conference.setEnd(DateUtil.parse("01.06.2013"));
		...
		talk1.setStart(DateUtil.parse("01.05.2013 12:30"));
		talk1.setEnd(DateUtil.parse("01.05.2013 14:30"));
		...
		talk2.setStart(DateUtil.parse("01.06.2013 12:30"));
		talk2.setEnd(DateUtil.parse("01.06.2013 14:30"));
